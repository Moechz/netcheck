# NetCheck 1.2.59 — review submission bundle
...
| File | Purpose |
|---|---|
| `netcheck_1.2.59_amd64.deb` | installed payload for amd64 |
| `netcheck_1.2.59_arm64.deb` | installed payload for arm64 |
...
sha256sum -c netcheck_1.2.59_amd64.deb.sha256
dpkg-deb -e netcheck_1.2.59_amd64.deb /tmp/netcheck-control   # maintainer scripts
dpkg-deb -x netcheck_1.2.59_amd64.deb /tmp/netcheck-payload   # installed payload
```
